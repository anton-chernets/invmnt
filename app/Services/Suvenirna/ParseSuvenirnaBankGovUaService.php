...
namespace App\Services\Suvenirna;
...
class ParseSuvenirnaBankGovUaService extends ParseBaseService
{
    private string $coinPageUrl;
    public function __construct(
        protected CoinRepository $coinRepository,
    ) {
        $this->coinPageUrl = env('COINS_BANK_GOV_UA_DOMAIN') . env('COINS_BANK_GOV_UA_SUVENIRNA_PAGE');
    }
